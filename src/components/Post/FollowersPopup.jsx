...
const FollowersPopup = ({ onClose, initialTab }) => {
    ...
    const fetchSuggestedUsers = useCallback(async () => {
        try {
            ...
            console.log('Utilisateurs suggérés récupérés:', suggested); // Debug: affiche les utilisateurs suggérés
    ...
    useEffect(() => {
        ...
        // console.log('Abonnements de l\'acteur:', user.follow); // Debug: affiche les abonnements de l'acteur
        const loadTabData = () => {
            setIsLoading(true);
            let data = [];
            ...
            // console.log('Données chargées:', data); // Pour le débogage
            setTabData(data);
            setIsLoading(false);
        };
