  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 bg-gradient-to-b from-purple-50 to-white min-h-screen">
            ...
            <div className="flex-grow">
              ...
              >
                <div
                  ...
                  onClick={() => handleOpenPopup('followers')} // Active l'onglet Abonnés
                >
                ...
                <div
                  className="bg-purple-50 p-4 rounded-xl text-center hover:bg-purple-100 transition-colors cursor-pointer"
                  onClick={() => handleOpenPopup('following')} // Active l'onglet Abonnements
                >
        ...
        {/* ... Modales et toasts avec animations ... */}
        <AnimatePresence>
          {user.showToast && (
            <motion.div
