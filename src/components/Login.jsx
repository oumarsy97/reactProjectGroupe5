...
const Login = () => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full flex justify-center items-center p-4">
            <div className="max-w-3xl w-full bg-gradient-to-r from-purple-900 to-indigo-900 rounded-xl shadow-lg flex flex-col lg:flex-row overflow-hidden relative">
                <motion.div
                ...
                <div className="hidden lg:block w-1/2 rounded-r-xl overflow-hidden bg-gradient-to-r from-purple-900 to-indigo-900">
                    ...
                    <motion.img
                        ...
                        alt="Logo"
                        className="absolute top-1/4 left-2/3 transform -translate-x-1/2 -translate-y-1/2 w-48"
